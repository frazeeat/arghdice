pub mod game{
    ...
    pub struct Game {
        ...
        pub dice_pile: Vec<i32>,
        pub dice_count: i32,
        pub dice_value: i32,
    }

    pub fn game_factory(number_of_players: i32) -> Game {
    ...
    pub fn determine_dice_pile(players: &Vec<Player>) -> Vec<i32> {
    ...
    impl Game {
        ...
        /// False otherwise.
        pub fn raise(&mut self, new_dice_count: i32, new_dice_value: i32) -> bool {
...
#[cfg(test)]
mod tests{
    use super::game::Player as Player;
    use super::game::Game as Game;
    use super::game::*;
